...
import telefunken.estimators.OmegaEstimate;
            ...
            for (int gi : glist) {
                ...
                for (double deg : dlist) {
                    ...
                    for (int gnum=0; gnum<NUMGRAPHS; gnum++) {
                        ...
                        List<Integer> hlist = Arrays.asList(10,7,4); 
                        for (int hi : hlist) {
                                ...
                                for (int trial=0; trial<NUMTRIALS; trial++) {
                                    ...
                                    for (int si : slist) 
                                    {
                                        ...
                                        double L = S.get_TrueL();
                                          ...
                                          List<Integer> elist = Arrays.asList(2); //0,1); // 0=closed form, 1=RDS-corrected, 2=ohash-corrected
                                          for (int ei : elist) {
