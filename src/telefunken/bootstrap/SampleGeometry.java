...
public abstract class SampleGeometry {
    ...
    private S_rS_M_Computer _helper;
    ...
    protected SampleGeometry(AbstractSample sample, IHasher losslessHasher) 
    {
        _hasher = losslessHasher;
        _sample = sample;
        
        _helper = new S_rS_M_Computer(sample, _hasher);
        _actualMatches = actualMatches(sample);
    ...
    public final double actualMatches(AbstractSample sample) 
    {
        return _helper.M.size();
    }
